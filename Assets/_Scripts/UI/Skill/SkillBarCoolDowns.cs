...
public class SkillBarCoolDowns : MonoBehaviour
{
    ...
    public void SkillCoolDown(SkillData.SkillType type, float CoolDown)
    {
        switch (type)
        {
            case SkillData.SkillType.Basic: StartCoroutine(TrackSkill(CoolDown, basicText, basicText_m, basicImage , basicImage_m)); break;
            case SkillData.SkillType.Offensive: StartCoroutine(TrackSkill(CoolDown, offensiveText, offensiveText_m, offensiveImage, offensiveImage_m));  break;
            case SkillData.SkillType.Mobility: StartCoroutine(TrackSkill(CoolDown, mobilityText, mobilityText_m, mobilityImage, mobilityImage_m)); break;
            case SkillData.SkillType.Defensive: StartCoroutine(TrackSkill(CoolDown, defensiveText, defensiveText_m, defensiveImage, defensiveImage_m)); break;
            case SkillData.SkillType.Utility: StartCoroutine(TrackSkill(CoolDown, utilityText, utilityText_m, utilityImage, utilityImage_m)); break;
            case SkillData.SkillType.Ultimate: StartCoroutine(TrackSkill(CoolDown, ultimateText, ultimateText_m, ultimateImage, ultimateImage_m)); break;
        }
    }
