...
public class EquipmentToolTip : MonoBehaviour
{
    ...
    private void Start()
    {
        if (equipmentSlot.Item != null)
        {
            ...
            if (equipmentSlot.Item is Equipment equipment)
            {
                UpdateEquipmentInfo(equipment);
            }

            if (equipmentSlot.Item is Weapon weapon)
            {
    ...
    public void UpdateCurrencyInfo()
    {
        ...
        sb.AppendLine(FormatNameWithRarity(equipmentSlot.Item.Prefab.name, equipmentSlot.Item.ItemRarity));
        sb.AppendLine();
        sb.AppendLine(equipmentSlot.Item.Description); // Description
